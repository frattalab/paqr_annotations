...
def get_non_overlapping_genes(gtf_df=None, subset_list=['protein_coding', 'lncRNA'], rm_na_tsl=True, gene_best_tsl=True, min_tsl=5, output_joined_df=False, output_filtered_df=False):
    '''
...
def get_multi_polya_transcripts(gtf_df=None, subset_list=None, polya_bed_path=None, polya_version=2, strand_specific=True, min_NOverlaps=2):
    '''
